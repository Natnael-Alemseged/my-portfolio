...
export const logoSvg = <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
        ...
        stroke="#7E22CE" strokeLinecap="round" strokeLinejoin="round" />
    <path
...
export const automatedPotentialSvg = <svg width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M30.3337 22.66H28.267C27.9028 22.6592 27.5484 22.7777 27.2579 22.9975C26.9675 23.2172 26.757 23.526 26.6587 23.8767L24.7003 30.8433C24.6877 30.8866 24.6614 30.9246 24.6253 30.9517C24.5893 30.9787 24.5454 30.9933 24.5003 30.9933C24.4552 30.9933 24.4114 30.9787 24.3753 30.9517C24.3393 30.9246 24.3129 30.8866 24.3003 30.8433L19.7003 14.4767C19.6877 14.4334 19.6614 14.3954 19.6253 14.3683C19.5893 14.3413 19.5454 14.3267 19.5003 14.3267C19.4552 14.3267 19.4114 14.3413 19.3753 14.3683C19.3393 14.3954 19.3129 14.4334 19.3003 14.4767L17.342 21.4433C17.244 21.7926 17.0348 22.1004 16.746 22.32C16.4573 22.5396 16.1048 22.659 15.742 22.66H13.667" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
</svg>;

export const taskAffectedSvg = <svg width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect y="0.659912" width="44" height="44" rx="22" fill="#F3E8FF" />
    <path d="M24.4997 14.3267H16.9997C16.5576 14.3267 16.1337 14.5023 15.8212 14.8148C15.5086 15.1274 15.333 15.5513 15.333 15.9933V29.3267C15.333 29.7687 15.5086 30.1926 15.8212 30.5052C16.1337 30.8177 16.5576 30.9933 16.9997 30.9933H26.9997C27.4417 30.9933 27.8656 30.8177 28.1782 30.5052C28.4907 30.1926 28.6663 29.7687 28.6663 29.3267V18.4933L24.4997 14.3267Z" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M23.667 14.3267V17.66C23.667 18.102 23.8426 18.5259 24.1551 18.8385C24.4677 19.1511 24.8916 19.3267 25.3337 19.3267H28.667" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M20.3337 20.1599H18.667" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M25.3337 23.4932H18.667" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M25.3337 26.8267H18.667" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
</svg>;

export const jobImpactAiToolsSvg = <svg width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect y="0.659912" width="44" height="44" rx="22" fill="#F3E8FF" />
    <path d="M22 19.3267C26.1421 19.3267 29.5 18.2074 29.5 16.8267C29.5 15.4459 26.1421 14.3267 22 14.3267C17.8579 14.3267 14.5 15.4459 14.5 16.8267C14.5 18.2074 17.8579 19.3267 22 19.3267Z" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14.5 16.8267V28.4933C14.5 29.1564 15.2902 29.7923 16.6967 30.2611C18.1032 30.7299 20.0109 30.9933 22 30.9933C23.9891 30.9933 25.8968 30.7299 27.3033 30.2611C28.7098 29.7923 29.5 29.1564 29.5 28.4933V16.8267" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14.5 22.6599C14.5 23.323 15.2902 23.9588 16.6967 24.4277C18.1032 24.8965 20.0109 25.1599 22 25.1599C23.9891 25.1599 25.8968 24.8965 27.3033 24.4277C28.7098 23.9588 29.5 23.323 29.5 22.6599" stroke="#9333EA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
</svg>;
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const ScaledSvg = ({ svg, width = 24, height = 24 }: any) => {

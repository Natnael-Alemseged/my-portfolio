...
export default function Projects({ initialProjects = [] }: { initialProjects?: Project[] }) {
    ...
    return (
        <section id="projects" className="relative bg-[#030303] py-20 px-6 md:px-12 text-white">
            <div className="absolute inset-x-0 -top-20 h-32 bg-gradient-to-b from-[#00ff9955] to-transparent blur-3xl pointer-events-none" />
                        ...
                        return (
                            ...
                            >
                                <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-400">
                                    ...
                                    <div className="absolute -inset-px rounded-[26px] border border-[#00ff99]/30 animate-pulse-slow" />
                                </div>
                                <div className="relative h-64 overflow-hidden rounded-t-3xl">
                                    ...
                                    <div className="absolute top-4 right-4 z-10 text-xs font-semibold px-3 py-1 rounded-full border border-white/40 backdrop-blur bg-black/70 text-white shadow-[0_10px_25px_rgba(0,0,0,0.5)]">
                                        {schemaLabel}
                                    </div>
                                    <div className="absolute bottom-4 left-4 right-4 flex flex-col gap-3">
                                        <h3 className="text-2xl font-bold text-white leading-tight">
                                            <Link href={`/projects/${project.slug}`} className="hover:text-emerald-300 transition">
                                                {project.title}
                                            </Link>
                                        </h3>
                                        <Link
